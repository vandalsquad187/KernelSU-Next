...
// 4.14 compat: SECCOMP_ARCH_NATIVE_NR + internal seccomp_filter layout only exist on 5.x+.
// On 4.14 provide no-op stubs (cache optimization not critical for root).
